...
export const Home = (): JSX.Element => {
  return (
    <div className="space-y-6">
      ...
      <Card className="w-full shadow-[0px_0px_25px_#00000026] rounded-xl mb-6 md:mb-[30px]">
        ...
        <CardContent className="p-4 md:p-6 grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
          <div>
            <p className="font-normal text-[#9d9d9d] text-base md:text-lg">
              Código da Unidade
            </p>
            <p className="font-normal text-black text-xl md:text-2xl mt-1">F301</p>
          </div>
          <div>
            <p className="font-normal text-[#9d9d9d] text-base md:text-lg">Unidade</p>
            <p className="font-normal text-black text-xl md:text-2xl mt-1">
              Fatec Votorantim
            </p>
          </div>
          <div>
